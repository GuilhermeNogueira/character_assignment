...
type Client struct {
	...
	// ShowItem Doer is the HTTP client used to make requests to the showItem
	// endpoint.
	...
	// AddItem Doer is the HTTP client used to make requests to the addItem
	// endpoint.
	AddItemDoer goahttp.Doer

	// RemoveItem Doer is the HTTP client used to make requests to the removeItem
	// endpoint.
...
// List returns an endpoint that makes HTTP requests to the inventory service
// list server.
func (c *Client) List() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("inventory", "list", err)
		}
...
// ShowItem returns an endpoint that makes HTTP requests to the inventory
// service showItem server.
func (c *Client) ShowItem() goa.Endpoint {
	var (
		encodeRequest  = EncodeShowItemRequest(c.encoder)
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("inventory", "showItem", err)
		}
		return decodeResponse(resp)
	}
}
...
// AddItem returns an endpoint that makes HTTP requests to the inventory
// service addItem server.
func (c *Client) AddItem() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("inventory", "addItem", err)
		}
		return decodeResponse(resp)
	}
}

// RemoveItem returns an endpoint that makes HTTP requests to the inventory
// service removeItem server.
func (c *Client) RemoveItem() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("inventory", "removeItem", err)
		}
		return decodeResponse(resp)
	}
}
