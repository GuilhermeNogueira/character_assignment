...
import (
	...
	charactersvr "characters/gen/http/character/server"
	inventorysvr "characters/gen/http/inventory/server"
	itemsvr "characters/gen/http/item/server"
	swaggersvr "characters/gen/http/swagger/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, characterEndpoints *character.Endpoints, inventoryEndpoints *inventory.Endpoints, itemEndpoints *item.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
