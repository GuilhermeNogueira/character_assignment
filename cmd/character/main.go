...
func main() {
	...
	)
	{
		...
		inventorySvc = characterapi.NewInventory(logger)
		itemSvc = characterapi.NewItem(logger)
	}
	...
	case "localhost":
		{
			...
			handleHTTPServer(ctx, u, characterEndpoints, inventoryEndpoints, itemEndpoints, &wg, errc, logger, *dbgF)
		}
